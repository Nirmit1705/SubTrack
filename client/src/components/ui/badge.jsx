...
const badgeVariants = cva(
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus-none focus-2 focus-ring focus-offset-2',
  {
    variants
      variant
        default:
          'border-transparent bg-primary text-primary-foreground shadow hover-primary/80',
        secondary:
          'border-transparent bg-secondary text-secondary-foreground hover-secondary/80',
        destructive:
          'border-transparent bg-destructive text-destructive-foreground shadow hover-destructive/80',
